...
async function startServer() {
  ...
  app.post("/api/leads", async (req, res) => {
    try {
      ...
      const recipient = "info@karotradz.com";
      const ccMail = ["govindaraj.poosamani@karotradz.com","senthil.durai@karotradz.com","kishan.vaghani@karotradz.com"];
...
<p style="margin-top:10px;font-size:12px;color:#c0c4cc;">
 © ${new Date().getFullYear()} KaroTradz. All Rights Reserved.
  ...
  const thankYouSubject = "Thanks for your interest in KaroTradz";
